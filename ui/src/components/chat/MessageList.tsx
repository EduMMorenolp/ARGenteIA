import { Globe, Plus, Send, Zap } from 'lucide-react';
      ...
      <div className="messages">
        <div className="welcome-container">
          <div className="welcome-hero">
            ...
            <p>
              Tu centro de mando inteligente. Puedo navegar la web, escribir archivos, ejecutar
              código y coordinar expertos.
            </p>
          </div>
          <div className="welcome-cards">
            ...
            <div
              className="w-card"
              onClick={() => onSetInput('Busca en Google las últimas noticias de IA')}
            >
              <Globe size={16} />
          ...
          return (
            <div key={msg.id} className="message-row assistant action-log">
              <div className="msg-container">
                <div
                  className="msg-bubble shadow-sm action_log"
                  style={{
                ...
                >
                  <div
                    ...
                    style={{ fontStyle: 'italic', fontSize: '0.9em', color: 'var(--text-muted)' }}
                  >
                    ⏳ {msg.text}
                  </div>
                </div>
            ...
            <div className="msg-container">
              <div className="msg-header">
                ...
                {msg.timestamp && (
                  <span
                    className="msg-time"
                    style={{ fontSize: '10px', opacity: 0.5, marginLeft: '8px' }}
                  >
              ...
              <div className={`msg-bubble shadow-sm ${msg.type}`}>
                <div
                  ...
                  dangerouslySetInnerHTML={
                    msg.role === 'assistant' ? renderContent(msg.text) : undefined
                  }
                >
