import { Zap, Bot, Edit2, Trash2, Plus, Calendar, LogOut, Cpu } from 'lucide-react';
                    ...
                    <div className="experts-list">
                        ...
                        {experts.map((exp) => (
                            <div key={exp.name} className={`expert-item-wrap ${selectedExpert === exp.name ? 'active' : ''}`}>
                                ...
                                <div className="expert-actions">
                                    <button onClick={() => onEditExpert(exp)}><Edit2 size={12} /></button>
                                    <button onClick={() => onDeleteExpert(exp.name)}><Trash2 size={12} /></button>
                                </div>
                            </div>
                        ))}
                    </div>
