...
export function DashboardModal({ stats, onClose, onRequestStats }: DashboardModalProps) {
  useEffect(() => {
    onRequestStats();
  }, []);
  ...
  const maxMessages = stats ? Math.max(...stats.dailyActivity.map((d) => d.messages), 1) : 1;
          ...
          <div className="dashboard-body scrollbar-hide">
            ...
            <div className="kpi-grid">
              <div className="kpi-card">
                ...
                <div className="kpi-data">
                  <span className="kpi-value">{formatNumber(stats.totalMessages)}</span>
              ...
              <div className="kpi-card">
                ...
                <div className="kpi-data">
                  <span className="kpi-value">{formatNumber(stats.totalTokens)}</span>
              ...
              <div className="kpi-card">
                ...
                <div className="kpi-data">
                  <span className="kpi-value">{formatLatency(stats.avgLatencyMs)}</span>
            ...
            <div className="dashboard-section">
              ...
              {stats.expertRanking.length === 0 ? (
                <div className="empty-state">Sin datos de expertos aún.</div>
              ) : (
                <div className="expert-ranking-table">
                  ...
                  {stats.expertRanking.map((exp, i) => (
                    <div key={exp.expert} className="ranking-row">
                      ...
                      <span className="ranking-tokens">{formatNumber(exp.tokens)}</span>
                      <span className="ranking-latency">{formatLatency(exp.avgLatency)}</span>
                    </div>
                  ))}
                </div>
              )}
