            ...
            <div className="modal-centered-wrapper" onClick={(e) => e.stopPropagation()}>
                ...
                <div className={`modal-side-panel left ${isLeftSidebarOpen ? "open" : ""}`}>
                    <div className="modal-side-inner" style={{ paddingTop: '56px' }}>
                        <h4 style={{ fontSize: "14px", color: "var(--text-main)", margin: 0, marginBottom: "12px" }}>Archivos</h4>
                ...
                {/* Main Modal */}
                <div className="modal-content" style={{ position: 'relative', zIndex: 10, margin: 0, width: '560px', maxWidth: '100%' }}>
                    ...
                    <div className="modal-header">
                        <div className="flex items-center gap-3">
                            ...
                            <h2 style={{ fontSize: '18px', margin: 0, color: 'var(--text-main)' }}>Memoria de Contexto (RAG)</h2>
                        </div>
