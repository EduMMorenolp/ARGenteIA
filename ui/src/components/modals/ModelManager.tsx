      ...
      <div className="modal-centered-wrapper" onClick={(e) => e.stopPropagation()}>
        ...
        <div className={`modal-side-panel left ${isOrSidebarOpen ? 'open' : ''}`}>
          <div className="modal-side-inner" style={{ paddingTop: '56px' }}>
            ...
            >
              <h4 style={{ fontSize: '14px', color: 'var(--text-main)', margin: 0 }}>
            ...
            {isOrDocOpen && (
              <div className="or-doc-panel">
                <p>
                  <strong>¿Cómo usar modelos de OpenRouter?</strong>
                </p>
                <ol>
                  <li>
                    Creá una cuenta en{' '}
                  ...
                  <li>
                    ...
                    y generá una API Key
                  </li>
                  <li>
                    Buscá el modelo que querés usar en la lista de abajo y hacé click en{' '}
                    <strong>"+ Añadir"</strong>
                  </li>
                  <li>En el formulario que aparece, pegá tu API Key en el campo correspondiente</li>
                  <li>
                    La URL base <code>https://openrouter.ai/api/v1</code> ya viene configurada
                    automáticamente
                  </li>
                </ol>
                <p style={{ fontSize: '11px', color: 'var(--text-muted)', marginTop: '8px' }}>
                  💡 Los modelos marcados como <strong style={{ color: '#10b981' }}>Gratis</strong>{' '}
              ...
              {loadingOr ? (
                ...
                filteredOrModels.map((m) => {
                  const promptPrice = m.pricing?.prompt
                    ? parseFloat(m.pricing.prompt) * 1000000
                    : 0;
                  return (
                    <div key={m.id} className="or-model-item">
                      ...
                      <div className="or-model-caps">
                        {promptPrice > 0 ? (
                          ...
                          <span className="cap-dot context or" style={{ color: '#10b981' }}>
                            Gratis
                          </span>
                        )}
                        <span className="cap-dot context">
                ...
                models.map((m) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      <button className="model-item-header" onClick={() => toggleExpand(m.name)}>
                        ...
                        <span className="model-item-name">{m.displayName || m.name}</span>
                        {/* Badges inline de capacidades */}
                        {info && (
                          <span className="model-caps-inline">
                            {info.supportsVision && (
                              <span className="cap-dot vision" title="Soporta imágenes">
                                📷
                              </span>
                            )}
                            {info.supportsAudio && (
                              <span className="cap-dot audio" title="Soporta audio">
                                🎤
                              </span>
                            )}
                            ...
                            <div className="model-edit-form">
                              <div className="form-group">
                                ...
                                <span className="field-hint">
                                  Opcional. Se mostrará en lugar del nombre técnico.
                                </span>
                              </div>
                              <div className="form-group">
        ...
        <div className={`modal-side-panel right ${isRightSidebarOpen ? 'open' : ''}`}>
          <div className="modal-side-inner" style={{ paddingTop: '56px' }}>
            <h4 style={{ marginBottom: '12px', fontSize: '14px', color: 'var(--text-main)' }}>
              Herramientas
            </h4>
