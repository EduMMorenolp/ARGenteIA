...
export function registerUserTools(config: Config): void {
  ...
  registerTool({
    ...
    spec: {
      ...
      function: {
        name: "update_profile",
        description: "Crea o actualiza el perfil del usuario con su nombre y zona horaria. Úsalo durante el onboarding o cuando el usuario quiera cambiar sus datos.",
        parameters: {
          type: "object",
          properties: {
            name: {
    ...
    handler: async (args, context) => {
      ...
      try {
        ...
        return `❌ Error al actualizar el perfil: ${err.message}`;
      }
    },
  });
}
